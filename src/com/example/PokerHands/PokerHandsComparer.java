...
public class PokerHandsComparer {
	...
	public static void main(String[] args) {
		...
		int pokerHandComparisonResult = hand0.compareTo(hand1);
		System.out.println(createOutputString(pokerHandComparisonResult));
		input = "Black: 2H 4S 4C 2D 4H  White: 2S 8S AS QS 3S";
		createPokerHands(input);
		pokerHandComparisonResult = hand0.compareTo(hand1);
		System.out.println(createOutputString(pokerHandComparisonResult));
